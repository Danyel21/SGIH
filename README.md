...
- Copie a pasta `SGIH` para o diretório público do seu servidor (ex.: C:\laragon\www\sibdas/1201707/SGIH).
- Configure a ligação à base de dados em [sibdas/1201707/SGIH/private/includes/db_connect.php](sibdas/1201707/SGIH/private/includes/db_connect.php#L1): atualize `DB_HOST`, `DB_NAME`, `DB_PORT`, `DB_USER`, `DB_PASS` conforme o seu ambiente.
...
- O ficheiro de configuração da base de dados encontra-se em [sibdas/1201707/SGIH/private/includes/db_connect.php](SGIH/private/includes/db_connect.php#L1). Atualize-o antes de iniciar a aplicação.
- Páginas de login/controlo de sessão: [sibdas/1201707/SGIH/public/login.php](sibdas/1201707/SGIH/public/login.php#L1) e [sibdas/1201707/SGIH/public/logout.php](SGIH/public/logout.php#L1).
